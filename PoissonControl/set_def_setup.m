...
def_setup.pow = 6;          % No of elts on edge is 2^pow
def_setup.bc = 'dirichlet'; % dirichlet, neumann or mixed
def_setup.beta = 1e-8;      % regularization parameter
...
def_setup.eig = 'none';     % print eigenvalues of -- 'exact' preconditioner or 'none'
